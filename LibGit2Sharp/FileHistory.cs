...
namespace LibGit2Sharp
{
    ...
    public static class FileHistoryExtensions
    {
        ...
        public static FileHistory Follow(this Repository repo, string path)
        {
        ...
        /// <exception cref="ArgumentNullException">When any of the parameters is null.</exception>
        public static FileHistory Follow(this Repository repo, string path, CommitFilter queryFilter)
        {
